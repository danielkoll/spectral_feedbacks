...
Scripts for computing the clearsky longwave spectral feedback expressions from Koll et al 2023. These scripts provide analytic approximations for the spectral terms that make up Earth's longwave clearsky feedback, and might or might not work well outside the present-day Earth parameter range in which they were tested. Even for present-day Earth, they are only an approximation.
